// $ANTLR 3.4 MicroParser.g 2012-12-07 18:08:42
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final MicroParserParser.param_decl_return param_decl() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==0 ) {SymbolTableClass.insertSymbolIntoTable((var_type32!=null?input.toString(var_type32.start,var_type32.stop):null), (id33!=null?input.toString(id33.start,id33.stop):null), null);}
    ...
    public final MicroParserParser.func_decl_return func_decl() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: id, 35, param_decl_list, func_body
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
            ...
            root_0 = (CommonTree)adaptor.nil();
            // 105:179: -> ^( 'FUNCTION' id ( param_decl_list )? func_body )
            {
                // MicroParser.g:105:182: ^( 'FUNCTION' id ( param_decl_list )? func_body )
                {
                CommonTree root_1 = (CommonTree)adaptor.nil();
                root_1 = (CommonTree)adaptor.becomeRoot(
                stream_35.nextNode()
                ...
                // MicroParser.g:105:198: ( param_decl_list )?
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    // MicroParser.g:109:4: func_decl
            	    {
            	    pushFollow(FOLLOW_func_decl_in_func_decl_tail410);
    ...
    public final MicroParserParser.func_body_return func_body() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_decl_in_func_body421);
            decl47=decl();
            ...
            pushFollow(FOLLOW_stmt_list_in_func_body425);
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    // MicroParser.g:117:4: stmt
            	    {
            	    pushFollow(FOLLOW_stmt_in_stmt_list438);
            	    stmt49=stmt();
        ...
        try {
            ...
            switch (alt11) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_base_stmt_in_stmt450);
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_if_stmt_in_stmt454);
                    if_stmt51=if_stmt();
                ...
                case 3 :
                    ...
                    pushFollow(FOLLOW_repeat_stmt_in_stmt458);
        ...
        try {
            ...
            switch (alt12) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_assign_stmt_in_base_stmt468);
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_read_stmt_in_base_stmt472);
                ...
                case 3 :
                    ...
                    pushFollow(FOLLOW_write_stmt_in_base_stmt476);
                ...
                case 4 :
                    ...
                    pushFollow(FOLLOW_return_stmt_in_base_stmt480);
    ...
    public final MicroParserParser.assign_stmt_return assign_stmt() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_assign_expr_in_assign_stmt492);
            ...
            char_literal58=(Token)match(input,26,FOLLOW_26_in_assign_stmt494); if (state.failed) return retval;
    ...
    public final MicroParserParser.assign_expr_return assign_expr() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_id_in_assign_expr505);
            id59=id();
            ...
            string_literal60=(Token)match(input,25,FOLLOW_25_in_assign_expr507); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_25.add(string_literal60);


            pushFollow(FOLLOW_expr_in_assign_expr509);
            expr61=expr();
    ...
    public final MicroParserParser.read_stmt_return read_stmt() throws RecognitionException {
        ...
        try {
            ...
            {
            string_literal62=(Token)match(input,39,FOLLOW_39_in_read_stmt530); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_39.add(string_literal62);


            char_literal63=(Token)match(input,18,FOLLOW_18_in_read_stmt532); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_18.add(char_literal63);


            pushFollow(FOLLOW_id_list_in_read_stmt534);
            id_list64=id_list();
            ...
            char_literal65=(Token)match(input,19,FOLLOW_19_in_read_stmt536); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_19.add(char_literal65);


            char_literal66=(Token)match(input,26,FOLLOW_26_in_read_stmt538); if (state.failed) return retval; 
    ...
    public final MicroParserParser.write_stmt_return write_stmt() throws RecognitionException {
        ...
        try {
            ...
            {
            string_literal67=(Token)match(input,46,FOLLOW_46_in_write_stmt556); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_46.add(string_literal67);


            char_literal68=(Token)match(input,18,FOLLOW_18_in_write_stmt558); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_18.add(char_literal68);


            pushFollow(FOLLOW_id_list_in_write_stmt560);
            id_list69=id_list();
            ...
            char_literal70=(Token)match(input,19,FOLLOW_19_in_write_stmt562); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_19.add(char_literal70);


            char_literal71=(Token)match(input,26,FOLLOW_26_in_write_stmt564); if (state.failed) return retval; 
    ...
    public final MicroParserParser.return_stmt_return return_stmt() throws RecognitionException {
        ...
        try {
            ...
            {
            string_literal72=(Token)match(input,41,FOLLOW_41_in_return_stmt582); if (state.failed) return retval; 
            if ( state.backtracking==0 ) stream_41.add(string_literal72);


            pushFollow(FOLLOW_expr_in_return_stmt584);
            expr73=expr();
            ...
            char_literal74=(Token)match(input,26,FOLLOW_26_in_return_stmt586); if (state.failed) return retval; 
    ...
    public final MicroParserParser.expr_return expr() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_expr_tail_in_expr606);
    ...
    public final MicroParserParser.expr_tail_return expr_tail() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_factor_in_expr_tail617);
            factor76=factor();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_addop_in_expr_tail620);
            	    addop77=addop();
            	    ...
            	    pushFollow(FOLLOW_factor_in_expr_tail623);
            	    factor78=factor();
    ...
    public final MicroParserParser.factor_return factor() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_postfix_expr_in_factor634);
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_mulop_in_factor637);
            	    mulop80=mulop();
            	    ...
            	    pushFollow(FOLLOW_postfix_expr_in_factor640);
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    pushFollow(FOLLOW_mulop_in_factor_tail654);
            	    mulop82=mulop();
            	    ...
            	    pushFollow(FOLLOW_postfix_expr_in_factor_tail657);
        ...
        try {
            ...
            switch (alt16) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_primary_in_postfix_expr669);
                    primary84=primary();
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_call_expr_in_postfix_expr673);
    ...
    public final MicroParserParser.call_expr_return call_expr() throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_id_in_call_expr683);
            id86=id();
            ...
            char_literal87=(Token)match(input,18,FOLLOW_18_in_call_expr685); if (state.failed) return retval; 
            ...
            switch (alt17) {
                case 1 :
                    // MicroParser.g:161:11: expr_list
                    {
                    pushFollow(FOLLOW_expr_list_in_call_expr687);
            ...
            char_literal89=(Token)match(input,19,FOLLOW_19_in_call_expr690); if (state.failed) return retval; 
    ...
    public final MicroParserParser.expr_list_return expr_list() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_expr_list_tail_in_expr_list712);
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    char_literal92=(Token)match(input,22,FOLLOW_22_in_expr_list_tail723); if (state.failed) return retval;
            	    if ( state.backtracking==0 ) {
            	    char_literal92_tree = 
            	    ...
            	    pushFollow(FOLLOW_expr_in_expr_list_tail725);
            	    expr93=expr();
        ...
        try {
            ...
            switch (alt19) {
                case 1 :
                    ...
                    {
                    char_literal94=(Token)match(input,18,FOLLOW_18_in_primary737); if (state.failed) return retval;

                    pushFollow(FOLLOW_expr_in_primary740);
                    expr95=expr();
                    ...
                    char_literal96=(Token)match(input,19,FOLLOW_19_in_primary742); if (state.failed) return retval;
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_id_in_primary748);
                    id97=id();
                ...
                case 3 :
                    ...
                    INTLITERAL98=(Token)match(input,INTLITERAL,FOLLOW_INTLITERAL_in_primary752); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    INTLITERAL98_tree = 
                ...
                case 4 :
                    ...
                    FLOATLITERAL99=(Token)match(input,FLOATLITERAL,FOLLOW_FLOATLITERAL_in_primary756); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    FLOATLITERAL99_tree = 
    ...
    public final MicroParserParser.if_stmt_return if_stmt() throws RecognitionException {
        ...
        try {
            ...
            string_literal102=(Token)match(input,36,FOLLOW_36_in_if_stmt801); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            char_literal103=(Token)match(input,18,FOLLOW_18_in_if_stmt803); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_cond_in_if_stmt805);
            cond104=cond();
            ...
            char_literal105=(Token)match(input,19,FOLLOW_19_in_if_stmt807); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            string_literal106=(Token)match(input,43,FOLLOW_43_in_if_stmt809); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_decl_in_if_stmt811);
            decl107=decl();
            ...
            pushFollow(FOLLOW_stmt_list_in_if_stmt813);
            ...
            pushFollow(FOLLOW_else_part_in_if_stmt819);
            ...
            string_literal110=(Token)match(input,33,FOLLOW_33_in_if_stmt821); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
        ...
        try {
            ...
            switch (alt20) {
                case 1 :
                    ...
                    string_literal111=(Token)match(input,31,FOLLOW_31_in_else_part836); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ...
                    pushFollow(FOLLOW_decl_in_else_part838);
                    decl112=decl();
                    ...
                    pushFollow(FOLLOW_stmt_list_in_else_part844);
    ...
    public final MicroParserParser.cond_return cond() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_expr_in_cond856);
            expr114=expr();
            ...
            pushFollow(FOLLOW_compop_in_cond858);
            compop115=compop();
    ...
    public final MicroParserParser.repeat_stmt_return repeat_stmt() throws RecognitionException {
        ...
        try {
            ...
            string_literal118=(Token)match(input,40,FOLLOW_40_in_repeat_stmt898); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_decl_in_repeat_stmt900);
            decl119=decl();
            ...
            pushFollow(FOLLOW_stmt_list_in_repeat_stmt904);
            ...
            string_literal121=(Token)match(input,44,FOLLOW_44_in_repeat_stmt906); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            char_literal122=(Token)match(input,18,FOLLOW_18_in_repeat_stmt908); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            pushFollow(FOLLOW_cond_in_repeat_stmt910);
            cond123=cond();
            ...
            char_literal124=(Token)match(input,19,FOLLOW_19_in_repeat_stmt912); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ...
            char_literal125=(Token)match(input,26,FOLLOW_26_in_repeat_stmt914); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
    ...
    public static final BitSet FOLLOW_func_decl_in_func_decl_tail410 = new BitSet(new long[]{0x0000000800000002L});
    public static final BitSet FOLLOW_decl_in_func_body421 = new BitSet(new long[]{0x0000439000000200L});
    public static final BitSet FOLLOW_stmt_list_in_func_body425 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_stmt_in_stmt_list438 = new BitSet(new long[]{0x0000439000000202L});
    public static final BitSet FOLLOW_base_stmt_in_stmt450 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_if_stmt_in_stmt454 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_repeat_stmt_in_stmt458 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_assign_stmt_in_base_stmt468 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_read_stmt_in_base_stmt472 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_write_stmt_in_base_stmt476 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_return_stmt_in_base_stmt480 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_assign_expr_in_assign_stmt492 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_26_in_assign_stmt494 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_id_in_assign_expr505 = new BitSet(new long[]{0x0000000002000000L});
    public static final BitSet FOLLOW_25_in_assign_expr507 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_expr_in_assign_expr509 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_39_in_read_stmt530 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_read_stmt532 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_id_list_in_read_stmt534 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_read_stmt536 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_26_in_read_stmt538 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_46_in_write_stmt556 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_write_stmt558 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_id_list_in_write_stmt560 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_write_stmt562 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_26_in_write_stmt564 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_41_in_return_stmt582 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_expr_in_return_stmt584 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_26_in_return_stmt586 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_expr_tail_in_expr606 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_factor_in_expr_tail617 = new BitSet(new long[]{0x0000000000A00002L});
    public static final BitSet FOLLOW_addop_in_expr_tail620 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_factor_in_expr_tail623 = new BitSet(new long[]{0x0000000000A00002L});
    public static final BitSet FOLLOW_postfix_expr_in_factor634 = new BitSet(new long[]{0x0000000001100002L});
    public static final BitSet FOLLOW_mulop_in_factor637 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_postfix_expr_in_factor640 = new BitSet(new long[]{0x0000000001100002L});
    public static final BitSet FOLLOW_mulop_in_factor_tail654 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_postfix_expr_in_factor_tail657 = new BitSet(new long[]{0x0000000001100002L});
    public static final BitSet FOLLOW_primary_in_postfix_expr669 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_call_expr_in_postfix_expr673 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_id_in_call_expr683 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_call_expr685 = new BitSet(new long[]{0x00000000000C0680L});
    public static final BitSet FOLLOW_expr_list_in_call_expr687 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_call_expr690 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_expr_in_expr_list710 = new BitSet(new long[]{0x0000000000400000L});
    public static final BitSet FOLLOW_expr_list_tail_in_expr_list712 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_22_in_expr_list_tail723 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_expr_in_expr_list_tail725 = new BitSet(new long[]{0x0000000000400002L});
    public static final BitSet FOLLOW_18_in_primary737 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_expr_in_primary740 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_primary742 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_id_in_primary748 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INTLITERAL_in_primary752 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FLOATLITERAL_in_primary756 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_36_in_if_stmt801 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_if_stmt803 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_cond_in_if_stmt805 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_if_stmt807 = new BitSet(new long[]{0x0000080000000000L});
    public static final BitSet FOLLOW_43_in_if_stmt809 = new BitSet(new long[]{0x000047B680000200L});
    public static final BitSet FOLLOW_decl_in_if_stmt811 = new BitSet(new long[]{0x0000439280000200L});
    public static final BitSet FOLLOW_stmt_list_in_if_stmt813 = new BitSet(new long[]{0x0000000280000000L});
    public static final BitSet FOLLOW_else_part_in_if_stmt819 = new BitSet(new long[]{0x0000000200000000L});
    public static final BitSet FOLLOW_33_in_if_stmt821 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_31_in_else_part836 = new BitSet(new long[]{0x000047B400000200L});
    public static final BitSet FOLLOW_decl_in_else_part838 = new BitSet(new long[]{0x0000439000000200L});
    public static final BitSet FOLLOW_stmt_list_in_else_part844 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_expr_in_cond856 = new BitSet(new long[]{0x0000000038020000L});
    public static final BitSet FOLLOW_compop_in_cond858 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_expr_in_cond861 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_40_in_repeat_stmt898 = new BitSet(new long[]{0x000057B400000200L});
    public static final BitSet FOLLOW_decl_in_repeat_stmt900 = new BitSet(new long[]{0x0000539000000200L});
    public static final BitSet FOLLOW_stmt_list_in_repeat_stmt904 = new BitSet(new long[]{0x0000100000000000L});
    public static final BitSet FOLLOW_44_in_repeat_stmt906 = new BitSet(new long[]{0x0000000000040000L});
    public static final BitSet FOLLOW_18_in_repeat_stmt908 = new BitSet(new long[]{0x0000000000040680L});
    public static final BitSet FOLLOW_cond_in_repeat_stmt910 = new BitSet(new long[]{0x0000000000080000L});
    public static final BitSet FOLLOW_19_in_repeat_stmt912 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_26_in_repeat_stmt914 = new BitSet(new long[]{0x0000000000000002L});
